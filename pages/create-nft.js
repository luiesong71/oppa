...
const projectId = "2NDut61DPB0ihXbDRVcRBRSKjxV";
const projectSecret = "364fbfbde05fd78acbbd8eba50bb8297";
const auth =
...
const dedicateEndPoint = "https://arc.infura-ipfs.io/ipfs";
          ...
          <div className="flex flex-col mx-8 sm:mx-12 lg:mx-[9vw] space-y-6 py-12 text-white dark:text-gray-800">
            ...
            <div className="flex flex-col lg:flex-row items-center">
              ...
              <div className="w-full lg:w-[40%] flex-none flex flex-col space-y-4">
                {/* file chooser */}
                <div className="bg-[#3a3a3a] dark:bg-white h-[160px] rounded-md border-dashed border border-[#9FA4FF] text-[#B4BAEF]">
                ...
                <input
                  className="text-[#B4BAEF] text-sm p-3.5 rounded-md border border-[#9FA4FF] bg-[#3a3a3a] dark:bg-white focus:outline-none focus:ring-2"
                ...
                <select
                  className="text-[#B4BAEF] text-sm px-3.5 py-3 rounded-md border border-[#9FA4FF] bg-[#3a3a3a] dark:bg-white focus:outline-none focus:ring-2 appearance-none custom-select"
                  placeholder="NFT Title"
                  defaultValue={0}
                  id="nft-category"
                  onChange={(e) =>
                ...
                <div className="relative text-[#B4BAEF]">
                  <input
                    className="w-full text-sm p-3.5 pr-16 rounded-md border border-[#9FA4FF] bg-[#3a3a3a] dark:bg-white focus:outline-none focus:ring-2"
                    type="number"
                    min={0}
                    placeholder="Price"
                    id="nft-price"
                ...
                {isActive ? (
                  <button
                    className="rounded-full bg-gradient-to-b from-[#ffffff] to-[#ffffff] text-black text-base px-6 sm:px-10 py-2 shadow-md m-auto"
                    id="btn-create-nft"
              ...
              <div className="flex-1 w-full h-full mt-8 lg:mt-0 pl-8 lg:pl-24 lg:pr-0">
                <div className="relative w-full h-auto">
                  ...
                  <img
                    src="/assets/svg/brand-ethereum.svg"
                  ...
                  <div className="absolute left-0 top-1/2 -translate-y-1/2  w-[57.5%] h-full flex flex-col items-start p-3 sm:p-6 lg:p-4 xl:p-8">
                    <h1 className="flex-none text-white text-xl sm:text-2xl py-2">
                      Abstr Gradient NFT
                    </h1>
                    <div className="flex-none flex flex-row items-center  w-full">
                      <div className="flex-none">
                        <img
                          src="/assets/svg/brand-abstr.svg"
                          className="w-2/3"
                        ></img>
                      </div>
                      <p className="flex-grow text-white text-sm sm:text-xl">
                        4363733
                      </p>
                    </div>
                    ...
                    <div className="w-full flex flex-row space-x-2 sm:space-x-4 text-white bg-[#FFCC33] bg-opacity-90 rounded-lg p-2 sm:p-3">
                      <div className="flex-1 flex flex-col space-y-1">
                        ...
                        <div className="flex flex-row items-center">
                          ...
                          <div className="flex flex-row text-xs sm:text-base lg:text-sm xl:text-base font-bold">
                            <div>0.25</div>
                            <div className="ml-1 sm:ml-2">Token</div>
                          </div>
                        </div>
                      </div>
