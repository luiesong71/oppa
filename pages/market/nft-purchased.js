        ...
        <div className="w-full 2xl:max-w-screen-2xl h-auto pt-[104px] m-auto">
          <div className="flex flex-col mx-8 sm:mx-16 lg:mx-[9vw] space-y-6 py-12">
            ...
            <div className="flex flex-col space-y-6">
              ...
              <div className="flex flex-row items-center space-x-4 rounded-md bg-[#3a3a3a] dark:bg-white border-2 border-[#3a3a3a] dark:border-2 dark:border-gray-200 p-4">
                <div className="flex-none grid place-items-center w-16 h-16 rounded-md bg-[#FFCC33] m-auto">
                  <FontAwesomeIcon
                    icon={faClone}
