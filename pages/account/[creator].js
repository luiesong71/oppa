          ...
          const items = await Promise.all(
            data.map(async (item) => {
              ...
              const replaceIPFsName = nftUrl
                .toString()
                .replace("ipfs.infura.io", "arc.infura-ipfs.io");
          ...
          <div className="flex flex-col mx-8 sm:mx-16 lg:mx-[9vw] space-y-6 py-12">
            ...
            <div className="flex flex-col space-y-6">
              <div className="relative h-[200px] rounded-md bg-gradient-to-b from-[#FFCC33] to-[#FFCC33]">
                ...
                <div className="absolute left-1/2 bottom-0 -translate-x-1/2 translate-y-1/2 w-[112px] h-[112px] rounded-full bg-gradient-to-b from-[#FFCC33] to-[#FFCC33]"></div>
              </div>
                    ...
                    {btnCategories.map((item, index) => (
                      <button
                        ...
                        className={classNames(
                          index === current
                            ? "bg-[#FFCC33] dark:bg-gray-800 text-white"
                            : "border border-[#2C3166] dark:border-gray-400 bg-[#1E1E1E] dark:bg-white text-[#919CC1] dark:text-gray-800",
