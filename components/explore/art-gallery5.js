      ...
      {props.galleries.map((item, index) => (
        ...
        >
          ...
          <div className="border-t-2 border-[#FFCC33] dark:border-gray-200 p-4">
            <button
              className="rounded-full bg-gradient-to-b from-[#ffffff] to-[#ffffff] text-white text-base w-full px-4 py-2 shadow-md"
              onClick={() => props.children.cancelSellFucnction(item)}
            >
              ⚡ {item.buttonTitle}
            </button>
          </div>
