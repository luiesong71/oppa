...
export default function ArtPreview(props) {
  return (
    <div className="flex flex-col lg:flex-row items-center space-x-0 space-y-8 lg:space-x-8 lg:space-y-0 bg-[#1E1E1E] border-2 border-[#1E1E1E] dark:bg-white dark:border-2 dark:border-gray-200 rounded-md p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="flex-1 flex flex-col space-y-6">
              <div className="flex flex-row space-x-4">
                <div className="flex-none w-14 h-14 rounded-full bg-gradient-to-b from-[#FFCC33] to-[#FFA25F]"></div>
              ...
              {props.children.item.sold ? (
                ...
                <button
                  className="w-48 rounded-full bg-gradient-to-b from-[#ffffff] to-[#ffffff] text-black text-base uppercase py-2 shadow-md m-auto ml-0 border-2 border-[#1E1E1E] dark:border-white"
                  onClick={() =>
