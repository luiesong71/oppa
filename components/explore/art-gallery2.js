        ...
        >
          <div className="grid grid-cols-1 gap-2 p-4">
            ...
            <div className="flex flex-row">
              ...
              >
                <button
                  className="rounded-full border-2 border-[#FFCC33] dark:border-0 dark:bg-[#FFCC33] w-[1.75rem] h-[1.75rem] text-white"
                  onClick={() =>
                    props.refresh
                      ? props.refresh(item.tokenId, item.itemId)
                      : ""
          ...
          <div className="border-t-2 border-[#FFCC33] dark:border-gray-200 p-4">
            {item.sold ? (
              ...
              <button
                className="rounded-full bg-gradient-to-b from-[#ffffff] to-[#ffffff] text-black text-base w-full px-4 py-2 shadow-md"
