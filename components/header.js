...
export default function Header(props) {
  ...
  return (
    <Disclosure
      as="nav"
      className="z-50 fixed w-full h-[104px] transition-all bg-[#1E1E1E] dark:bg-white dark:border-b dark:border-gray-200"
    >
      {({ open }) => (
                        ...
                        <div className="h-full grid place-items-center">
                          <Menu.Button className="inline-flex justify-center w-full px-0 py-2 text-sm font-medium">
                            <div className="flex flex-row space-x-4">
                              <div className="flex-none w-12 h-12 rounded-full bg-gradient-to-b from-[#FFCC33] to-[#FFA25F]"></div>
