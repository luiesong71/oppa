    ...
    return (
        <Transition appear show={props.show} as={Fragment}>
            ...
            <div className="min-h-screen px-4 text-center">
                ...
                >
                <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-[#1c1c1c] dark:bg-white shadow-xl">
                    <Dialog.Title
                    as="h3"
                    ...
                    <div className='flex flex-col space-y-2'>
                        ...
                        <div className='relative text-[#B4BAEF] dark:text-gray-600 py-4'>
                            ...
                            <p className='absolute top-1/2 right-8 -translate-y-1/2 text-sm'>Token</p>
                    ...
                    <div className="mt-2">
                        <button
                            type="button"
                            className="px-10 py-2 text-sm font-medium bg-gradient-to-b from-[#F3B74D] to-[#F3B74D] text-black bg-blue-100 border border-transparent rounded-full hover:bg-blue-200"
